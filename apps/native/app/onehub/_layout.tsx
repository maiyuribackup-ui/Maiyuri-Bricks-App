...
export default function OneHubLayout() {
  return (
    ...
    >
      ...
      <Stack.Screen
        name="edit/[slug]"
        options={{ title: "Edit SOP", presentation: "modal" }}
      />
      ...
      <Stack.Screen name="processes/index" options={{ title: "Processes" }} />
      <Stack.Screen name="processes/[key]" options={{ title: "Process Map" }} />
      <Stack.Screen
        name="processes/case/[id]"
        options={{ title: "Process Case" }}
      />
